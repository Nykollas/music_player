...
export default function repeat(props) {
    ...
    return (
        ...
        <svg height={style.height} width={style.width}  version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
             viewBox="0 0 512.016 512.016"  space="preserve">
        <g>
            <g>
                <path fill={style.fill} d="M507.336,100.696l-96-96c-4.576-4.576-11.456-5.952-17.44-3.456c-5.984,2.496-9.888,8.288-9.888,14.752v48h-208
        ...
        <g>
            <g>
                <path fill={style.fill} d="M496.008,255.992h-64c-8.832,0-16,7.168-16,16c0,44.192-35.808,80-80,80h-208v-48c0-6.464-3.904-12.32-9.888-14.784
